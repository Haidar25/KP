        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="contactno" placeholder="Nomor Telpon" minlength="12" maxlength="10" autocomplete="off" onkeypress="return validatePhone(event);" required>
              </div>
              <div class="form-group">
