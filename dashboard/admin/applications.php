                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php if($row['resume'] != '') { ?>
                        <td><a href="../../uploads/resume/<?php echo $row['resume']; ?>" download="<?php echo $row['firstname'].' Resume'; ?>"><i class="fa fa-file-pdf-o">&nbsp&nbsp<span class="label label-success">Unduh</span> </i></a></td>
                        <?php } else { ?>
