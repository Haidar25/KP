            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="my-job-post.php"><i class="fa fa-tv"></i> Lowongan Saya</a></li>
               ...
               $sql = "SELECT users.*, pencaker.nama, pencaker.kecamatan FROM users INNER JOIN pencaker ON pencaker.id_user = users.id_user WHERE users.id_user='$_GET[id]'";
                ...
                <div>
                  <?php
                    ...
                    echo '<br>';
                    if($row['resume'] != "") {
                      echo '<a href="../../uploads/resume/'.$row['resume'].'" class="btn btn-info" download="Resume">Download CV/Resume</a>';
                    }
                    echo '<br>';
                    echo '<br>';
                    echo '<br>';
