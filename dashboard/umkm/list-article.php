            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="create-article.php"><i class="fa fa-address-card"></i> Buat Artikel</a></li>
                  <li class="active"><a href="list-article.php"><i class="fa fa-address-card"></i> Daftar Artikel</a></li>
